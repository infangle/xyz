class NumMatrix:
    ...
    def sumRegion(self, row1: int, col1: int, row2: int, col2: int) -> int:
        if row1 == 0 and col1 == 0:
            submatrix_sum = self.prefix[row2][col2]
        elif row1 == 0:
            submatrix_sum = self.prefix[row2][col2] - self.prefix[row2][col1-1]
        elif col1 == 0:
            submatrix_sum = self.prefix[row2][col2] - self.prefix[row1-1][col2]
        else:
